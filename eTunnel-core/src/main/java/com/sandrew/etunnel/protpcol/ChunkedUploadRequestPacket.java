...
/**
 * @ClassName ChunkedUploadRequestPacket
 * @Description
 * @Author summer
 * @Date 2024/3/21 10:38
 **/
public class ChunkedUploadRequestPacket extends Packet
{
    ...
    public ChunkedUploadRequestPacket()
    {
    }

    public ChunkedUploadRequestPacket(Serializer aSerializer)
    {
